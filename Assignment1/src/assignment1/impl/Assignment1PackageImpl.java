...
public class Assignment1PackageImpl extends EPackageImpl implements Assignment1Package {
	 ...
	 * @generated
	 */
	private EClass courseChoiceEClass = null;
	 ...
	 * @generated
	 */
	public EAttribute getProgram_GradYear() {
	 ...
	 * @generated
	 */
	public EReference getProgram_Year() {
	 ...
	 * @generated
	 */
	public EReference getYear_CourseChoice() {
	 ...
	 * @generated
	 */
	public EAttribute getYear_Credits() {
	 ...
	 * @generated
	 */
	public EClass getCourseChoice() {
		return courseChoiceEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getCourseChoice_Criteria() {
		return (EAttribute)courseChoiceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getCourseChoice_Course() {
		return (EReference)courseChoiceEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCourse_Role() {
	 ...
	 * @generated
	 */
	public EAttribute getLecturer_Name() {
	 ...
	 * @generated
	 */
	public EAttribute getLecturer_GivenName() {
		return (EAttribute)lecturerEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getLecturer_FamilyName() {
		return (EAttribute)lecturerEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(programEClass, PROGRAM__GRAD_YEAR);
		createEReference(programEClass, PROGRAM__YEAR);
		...
		createEReference(yearEClass, YEAR__COURSE_CHOICE);
		createEAttribute(yearEClass, YEAR__CREDITS);

		courseChoiceEClass = createEClass(COURSE_CHOICE);
		createEAttribute(courseChoiceEClass, COURSE_CHOICE__CRITERIA);
		createEReference(courseChoiceEClass, COURSE_CHOICE__COURSE);

		courseEClass = createEClass(COURSE);
		createEAttribute(courseEClass, COURSE__NAME);
		createEAttribute(courseEClass, COURSE__COURSE_CODE);
		createEAttribute(courseEClass, COURSE__CREDITS);
		createEAttribute(courseEClass, COURSE__ROLE);
		...
		createEAttribute(lecturerEClass, LECTURER__NAME);
		createEAttribute(lecturerEClass, LECTURER__GIVEN_NAME);
		createEAttribute(lecturerEClass, LECTURER__FAMILY_NAME);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getProgram_GradYear(), ecorePackage.getEInt(), "gradYear", null, 0, 1, Program.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProgram_Year(), this.getYear(), null, "year", null, 0, -1, Program.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProgram_Specialization(), this.getSpecialization(), null, "specialization", null, 0, 1, Program.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(specializationEClass, Specialization.class, "Specialization", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSpecialization_Program(), this.getProgram(), null, "program", null, 0, 1, Specialization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getYear_CourseChoice(), this.getCourseChoice(), null, "courseChoice", null, 0, 1, Year.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getYear_Credits(), ecorePackage.getEFloat(), "credits", null, 0, 1, Year.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(courseChoiceEClass, CourseChoice.class, "CourseChoice", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCourseChoice_Criteria(), ecorePackage.getEString(), "criteria", null, 0, 1, CourseChoice.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourseChoice_Course(), this.getCourse(), null, "course", null, 0, -1, CourseChoice.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCourse_Role(), ecorePackage.getEString(), "role", null, 0, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCourse_Lecturer(), this.getLecturer(), null, "lecturer", null, 0, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(lecturerEClass, Lecturer.class, "Lecturer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLecturer_Name(), ecorePackage.getEString(), "name", null, 0, 1, Lecturer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLecturer_GivenName(), ecorePackage.getEString(), "givenName", null, 0, 1, Lecturer.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getLecturer_FamilyName(), ecorePackage.getEString(), "familyName", null, 0, 1, Lecturer.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
