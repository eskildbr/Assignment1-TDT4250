 ...
 * </p>
 * <ul>
 *   <li>{@link assignment1.impl.LecturerImpl#getName <em>Name</em>}</li>
...
public class LecturerImpl extends MinimalEObjectImpl.Container implements Lecturer {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Assignment1Package.LECTURER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Assignment1Package.LECTURER__NAME:
				return getName();
